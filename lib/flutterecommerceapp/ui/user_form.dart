...
import 'package:flutter_ecommerce_app/flutterecommerceapp/ui/bottom_nav_controller.dart';
          ...
          children: [
            ...
            TextField(
              ...
              decoration: InputDecoration(
                ...
                suffixIcon: IconButton(onPressed: ()=>_selectDateFormPicker(context), icon: Icon(Icons.calendar_today_outlined))
              ),
            ...
            TextField(
              ...
              decoration: InputDecoration(
               ...
               prefixIcon: DropdownButton(style:TextStyle(color: Colors.blueGrey),items: gender.map((String value) {
                 return DropdownMenuItem(child: Text(value),value: value,onTap: (){
